...
const Sidebar: React.FC<{ isOpen: boolean; closeSidebar: () => void }> = ({
  ...
  return (
    <>
      <aside
        className={`lg:flex flex-col w-full md:w-[50%] lg:w-[15rem] h-full fixed z-10 overflow-x-hidden bg-white border-r-2 ${
          isOpen ? "flex" : "hidden"
        }`}>
        <div className="flex relative">
          <button
            className="p-3 bg-[#005AE2] w-4/5 rounded-lg text-white font-bold"
            onClick={handleClick}>
            Create New
          </button>
          {active ? (
            <div className="ml-20 mt-10 flex flex-col absolute text-sm bg-white shadow-lg rounded-2xl w-52 justify-center p-2 text-[#005AE2]">
              ...
              <Link
                href="/dashboard/customshortlinks"
                className="p-2 font-bold"
                onClick={closeSidebar}>
                Custom link
              </Link>
        ...
        <div className="flex flex-col mt-6  border-y-2 py-5">
          <ul className="space-y-10 font-bold text-sm text-[#2E4457]">
            ...
            <li
              className={
                pathName === "/dashboard/shortlinks" ? "text-[#005AE2]" : ""
              }>
              <Link
                href="/dashboard/shortlinks"
                className="flex gap-3 items-center"
            ...
            <li
              className={
                pathName === "/dashboard/customshortlinks"
                  ? "text-[#005AE2]"
                  : ""
              }>
              <Link
            ...
            <li
              className={
                pathName === "/dashboard/qrcodes" ? "text-[#005AE2]" : ""
              }>
              <Link
                href="/dashboard/qrcodes"
                className="flex gap-3 items-center"
            ...
            <li
              className={
                pathName === "/dashboard/customdomain" ? "text-[#005AE2]" : ""
              }>
              <Link
                href="/dashboard/customdomain"
                className=" flex gap-3 items-center "
                onClick={closeSidebar}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  <path
                    fill="#005AE2"
                    d="m10.95 13.65l-1.375-1.375q-.3-.3-.725-.3t-.725.3q-.3.3-.3.725t.3.725l2.125 2.125q.3.3.7.3t.7-.3l4.225-4.225q.3-.3.3-.725t-.3-.725q-.3-.3-.725-.3t-.725.3L10.95 13.65ZM4 8h16V6H4v2Zm0 12q-.825 0-1.413-.588T2 18V6q0-.825.588-1.413T4 4h16q.825 0 1.413.588T22 6v12q0 .825-.588 1.413T20 20H4Z"
                  />
                </svg>
                Custom Domain
              </Link>
            ...
            <li
              className={
                pathName === "/dashboard/settings" ? "text-[#005AE2]" : ""
              }>
              <Link
