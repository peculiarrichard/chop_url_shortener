...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
    <section className='flex flex-col w-[15rem] h-full fixed z-10 overflow-x-hidden bg-white border-r-2'>
    ...
    <div className='flex flex-col mt-6  border-y-2 py-5'>
      <ul className='space-y-10 font-bold text-sm text-[#2E4457]'>
        ...
        <li className={pathName === '/dashboard/shortlinks'? 'text-[#005AE2]': ''}>
          <Link href="/dashboard/shortlinks" className='flex gap-3 items-center'>
        ...
        <li className={pathName === '/dashboard/customshortlinks'? 'text-[#005AE2]': ''}>
          <Link href="/dashboard/customshortlinks" className=' flex gap-3 items-center'>
        ...
        <li className={pathName === '/dashboard/qrcodes'? 'text-[#005AE2]': ''}>
          <Link href="/dashboard/qrcodes" className='flex gap-3 items-center'>
        ...
        <li className={pathName === '/dashboard/customdomain'? 'text-[#005AE2]': ''}>
          <Link href="/dashboard/customdomain" className=' flex gap-3 items-center '>
        ...
        <li className={pathName === '/dashboard/settings'? 'text-[#005AE2]': ''}>
          <Link href="/dashboard/settings" className='gap-3 flex items-center'>
